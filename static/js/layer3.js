...
function replicateDropdown() {
    ...
    var cloneButton = cloneDiv.querySelector('button.plus-widget');
    cloneButton.classList.remove('plus-widget'); // Remove btn-primary class
    cloneButton.classList.add('minus-widget'); // Add minus-widget class
    cloneButton.innerHTML = '-'; // Change button content to image
